...
struct SettingsView: View {
    ...
    @AppStorage("playdateplanner_notifyEnabled") private var notifyEnabled = true
    @AppStorage("playdateplanner_iCloudSyncEnabled") private var iCloudSyncEnabled = false
    ...
    var body: some View {
        NavigationStack {
            Form {
                ...
                Section("About") {
                    Link("Privacy Policy", destination: URL(string: "https://shimondeitel.github.io/playdateplanner-app/privacy.html")!)
                    Text("Version 1.0")
